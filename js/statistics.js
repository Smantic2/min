...
const statistics = {
  ...
  initialize: function () {
    ...
    statistics.registerGetter("extensionPerformance", function () {
      return settings.get("extensionPerformance") || null;
    });

    statistics.registerGetter("extensionWarning", function () {
      return settings.get("extensionPerformanceWarning") || null;
    });
  },
};
