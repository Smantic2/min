...
var requestOverheadSampleCounter = 0;
...
function handleRequest(details, callback) {
  ...
  function sendCallback(result) {
    ...
    requestOverheadSampleCounter++;
    if (
      requestOverheadSampleCounter % 100 === 0 &&
      typeof extensionManager !== "undefined" &&
      extensionManager.recordRequestOverhead
    ) {
      extensionManager.recordRequestOverhead(Date.now() - requestStartTime);
    }
  }
